# Note
This tool was originally created by python, later went in private, but I still had source-code. I take no credits for this.

<h1 align="center">[Discord] - Fake Verification Bot With QR CODE (V1.0.0)
